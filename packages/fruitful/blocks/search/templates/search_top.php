...
<form action="<?php  echo $view->url( $resultTargetURL )?>" method="get" class="ccm-search-block-form row">
	...
	<input name="query" placeholder="<?php echo $title?>" type="text" value="<?php  echo htmlentities($query, ENT_COMPAT, APP_CHARSET)?>" class="ccm-search-block-text form-control" />
    </div>
    <div class="col-xs-4 col-md-2">
    <input name="submit" type="submit" value="<?php  echo $buttonText?>" class="btn btn-default ccm-search-block-submit" />
    </div>
