    ...
    for ($i = 0; $i < count($cArray); $i++ ) {
        ...
        ?>
            <article class="entry <?php  echo $entryClasses?>">
                <header class="row">
                    <div class="col-xs-3">
                        <time class="date" datetime="<?php echo $dh->formatCustom(t('M d, Y'),strtotime($blogDate))?>">
                            <div class="day"><?php echo $dh->formatCustom('d',$blogDate)?></div>
                            <div class="month"><?php echo $dh->formatCustom('M',$blogDate)?></div>  
                        </time>
                    </div>
                    <div class="col-xs-9">
                ...
                <div class="entry-content row">
                    <div class="col-xs-9 col-xs-offset-3">
                        <p><?php echo $blogify->closetags($content);?></p>
                    </div>
                </div>
                <div class="read-more-shell row">
                    <div class="col-xs-12">
                       <a class="btn-read-more" href="<?php echo $url?>"><?php echo t('Read More')?></a>
                    </div>
                </div>
